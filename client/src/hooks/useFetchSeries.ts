        ...
        const fetchSeries = async () => {
            ...
            try {
                if ((props.library.id > 0) && (props.seriesId > 0)) {
                    ...
                    const theSeries = await SeriesClient.find(props.library.id, props.seriesId, {
                        withAuthors: "",
                        withStories: "",
                    });
                    ...
                    for (const story of theSeries.stories) {
                    ...
                    logger.info({
                        ...
                        msg: "Return fetched Series with nested objects",
