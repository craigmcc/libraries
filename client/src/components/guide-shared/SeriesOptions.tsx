...
// List Serieses that match search criteria, offering callbacks for adding,
// editing, including (marking this Series as part of this Author/Story), or
// excluding (marking this Series as not part of this Author/Story).
...
export interface Props {
    ...
    handleExclude: HandleSeries;        // Handle request to exclude a Series
    handleInclude: HandleSeries;        // Handle request to include a Series
    handleSelect: HandleSeries;         // Handle request to select a Series
    included: (series: Series) => boolean; // Is the specified Series included?
    parent: Author | Library | Story;   // Parent object for requested Serieses
}
                            ...
                            <td key={1000 + (rowIndex * 100) + 99}>
                                ...
                                {(!(props.parent instanceof Library)) ? (
                                    <>
                                        <Button
                                            className="mr-1"
                                            disabled={props.included(series)}
